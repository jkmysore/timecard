 <div class="leftpanel">     
    ...
    <div class="leftpanelinner"> 
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="nav-parent" id="organization1"><a href=""><i class="fa fa-edit"></i> <span>Organization</span></a>
          <ul class="children">
            <li><a href="${pageContext.request.contextPath}/organization/add.htm"><i class="fa fa-caret-right"></i> Add </a></li>
