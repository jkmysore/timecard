	               ...
	               <div class="form-group">
	                ...
	                <div class="form-group">
		                <label class="col-sm-2 control-label" >Division Id<span class="asterisk">*</span></label>
		                  <div class="col-sm-4">
		                    <form:input type="text" required="required" placeholder="Type your Division Id..." class="form-control" path="divisionNo" id="departmentId" /><span id="departmentId_error" style="color:red"></span>
		                    <form:errors path="divisionNo" id="lastName_error" class="org_error"/>
		                  </div>
	                </div>
					<div class="form-group">
		                <label class="col-sm-2 control-label" >Division Name<span class="asterisk">*</span></label>
		                  <div class="col-sm-4">
		                    <form:input type="text" required="required" placeholder="Type your Division Name..." class="form-control" path="divisionName" id="departmentName" /><span id="departmentName_error" style="color:red"></span>
		                    <form:errors path="divisionName" id="username_error" class="org_error"/>
		                  </div>
	                </div>
