...
<body>
	...
	<div class="contentpanel">
      ...
      <div class="row">
        ...
        <div class="col-md-11">
          <form:form class="form-horizontal" action="${pageContext.request.contextPath}/organization/configuration.htm" method="post" id="basicForm" novalidate="novalidate" commandName="configuration" enctype="multipart/form-data" onsubmit="return validateConfiguration();">
	          <div class="panel panel-default">
	              ...
	              <div class="panel-body">
	                <div class="form-group">
	                  ...
	                  <div class="col-sm-4">
	                    <form:select path="timecardPeriod.id" required="required" class="form-control" id="timecardPeriod">	                    
	                  ...
	                  </div><span class="configuration_error" id="timecardperiod_error"></span>
	                 </div>
					...
					<div class="form-group">
	                  ...
	                  <div class="col-sm-4">
	                    <form:select path="weekEndingDay" required="required" class="form-control" id="weekEndingDay">	                    
	                    	<form:option value="">--Select--</form:option>
	                  ...
	                  </div><span class="configuration_error" id="weekEndingDay_error"></span>
	                </div>
	                
	                <div class="form-group">
	                  <label class="col-sm-2 control-label">Min Hours Per Week<span class="asterisk">*</span></label>
	                  <div class="col-sm-4">
	                    <form:input type="text" required="required" placeholder="Type your Min Hours..." class="form-control" path="minHoursPerWeek"  id="minHoursPerWeek"/>
	                 	 <form:errors id="minHoursPerWeek_error" class="org_error" path="minHoursPerWeek"/>
	                  </div> <span class="configuration_error" id="minHoursPerWeek_error"></span>
	                </div>
				
					 <div class="form-group">
	                  <label class="col-sm-2 control-label">Max Hours Per Week<span class="asterisk">*</span></label>
	                  <div class="col-sm-4">
	                    <form:input type="text" required="required" placeholder="Type your Max Hours..." class="form-control" path="maxHoursPerWeek" id="maxHoursPerWeek" />
	                 	 <form:errors id="maxHoursPerWeek_error" class="org_error" path="maxHoursPerWeek"/>
	                  </div><span class="configuration_error" id="maxHoursPerWeek_error"></span>
	                </div>
					
					 <div class="form-group">
	                  <label class="col-sm-2 control-label">Whine List<span class="asterisk">*</span></label>
	                  <div class="col-sm-4">
	                    <form:input type="text" required="required" placeholder="Type your Whine List..." class="form-control" path="whineList"  id="whineList"/>
	                 	 <form:errors id="whineList_error" class="org_error" path="whineList"/>
	                  </div><span class="configuration_error" id="whineList_error"></span>
	                </div>
