	          ...
	          <div class="panel panel-default">
	              ...
	              <div class="panel-body">
	                <div class="form-group">
	                  ...
	                  <div class="col-sm-4">
	                    <form:input type="text" required="required" placeholder="Type your Organization Name..." class="form-control" path="organizationName" />
					...
					<div class="form-group">
	                  ...
	                  <div class="col-sm-4">
	                    <form:input type="text" required="required" placeholder="Type your Organization Short Name..." class="form-control" path="organizationShortName" />
	                ...
	                <div class="form-group">
	                  ...
	                  <div class="col-sm-4">
		                    <form:input type="file" required="required" placeholder="Logo file" class="form-control" path="logo" />
					...
					<div class="form-group">
		                <label class="col-sm-2 control-label">Site Admin User Name</label>
		                  <div class="col-sm-4">
		                    <form:input type="text" required="required" placeholder="Type your Site Admin User Name..." class="form-control" path="siteAdminUserName" />
		                    <form:errors path="siteAdminUserName" id="siteAdminUserName_error" class="org_error"/>
		                  </div>
	                </div>
					...
					<div class="form-group">
		                  ...
		                  <div class="col-sm-4">
		                    <form:input type="siteAdminEmail" required="required" placeholder="Type your Site Admin email..." class="form-control" path="siteAdminEmail" />
		                  	  <form:errors path="siteAdminEmail" id="siteAdminEmail_error" class="org_error"/>
		                  </div>
	                </div>
					...
					<div class="form-group">
		                  ...
		                  <div class="col-sm-4">
		                    <form:input type="email" required="required" placeholder="Type your Site Admin Password..." class="form-control" path="siteAdminPassword" />
		                      <form:errors path="siteAdminPassword" id="siteAdminPassword_error" class="org_error"/>
		                  </div>
	                </div>
